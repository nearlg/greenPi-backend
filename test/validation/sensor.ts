...
describe('Sensor validation', () => {
  describe('Name validation', () => {
    it('Name with invalid characters', () => {
      return expect(sensorValidator.validateName('++4 4')).to.be.rejected;
    });
  ...
  describe('Description validation', () => {
    it('Description with some characters', () => {
      return expect(sensorValidator.validateDescription('++4 4')).to.be
        .fulfilled;
    });

    it('Description can be an empty string', () => {
      return expect(sensorValidator.validateDescription('')).to.be.fulfilled;
    });

    it('Description can be null', () => {
      return expect(sensorValidator.validateDescription(null)).to.be.fulfilled;
    });

    it('Description can be undefined', () => {
      return expect(sensorValidator.validateDescription(undefined)).to.be
        .fulfilled;
    });
  });
  ...
  describe('Type validation', () => {
    it('Type can be an object', () => {
      return expect(sensorValidator.validateType(<SensorType>{})).to.be
        .fulfilled;
    });

    it('Type can be an string', () => {
      return expect(sensorValidator.validateType('asdasdasds')).to.be.fulfilled;
    });

    it('Type can not be an epmty string', () => {
      return expect(sensorValidator.validateType('')).to.be.rejected;
    });

    it('Type can not be undefined', () => {
      return expect(sensorValidator.validateType(undefined)).to.be.rejected;
    });

    it('Type can not be null', () => {
      return expect(sensorValidator.validateType(null)).to.be.rejected;
    });
  });
});
